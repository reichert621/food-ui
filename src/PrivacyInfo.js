...
export default function PrivacyInfo() {
  return (
    <div>
      <div>
        <h1>Privacy Policy of the Pluot Facebook app</h1>
        <p>
      ...
      <div>
        ...
        <p>333 Harrison St, San Francisco, CA 94105, USA,</p>
        <p>team@hipluot.com</p>
      </div>
      <div>
        ...
        <p>
          ...
          the Data collection.<br />The Personal Data may be freely provided by
          the User, or collected automatically when using this Application.<br />Any
          use of Cookies - or of other tracking tools - by this Application or
          by the owners of third party services used by this Application, unless
          ...
          the User.<br />Failure to provide certain Personal Data may make it
      ...
      <div>
        ...
        <p>
          ...
          Data.<br />The Data processing is carried out using computers and/or
          ...
          of persons in charge, involved with the operation of the site
      ...
      <div>
        ...
        <p>
          ...
          information, including Personal Data, from it.
        </p>
        <p>
      ...
      <div>
        ...
        <p>
          ...
          arising from improper use of this Application or the related services.<br />The
          User declares to be aware that the Data Controller may be required to
